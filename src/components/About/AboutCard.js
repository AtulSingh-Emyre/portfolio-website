      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am currently working at 6D Technologies, Bangalore as a Software Engineer. Here, I have worked mainly on React JS (Frontend) and various services under AWS and Kubernetes.
